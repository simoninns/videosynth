...
|------|----------|--------|------------|
| `pal_cav_disc.yaml` | PAL | composite | CAV biphase, pilot burst, VITS, OSD, noise, dropouts, audio, EXR+MKV |
| `pal_clv_disc.yaml` | PAL | composite | CLV biphase codes, VITS, OSD, noise |
| `ntsc_cav_disc.yaml` | NTSC | composite | CAV biphase + FM codes, VIRS, OSD, noise, dropouts, audio |
