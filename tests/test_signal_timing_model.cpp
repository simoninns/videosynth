...
TEST(SignalTimingModelTest, ClassifiesPalSyncBlocksAndLineKinds) {
  ...
  EXPECT_EQ(GetSyncPulseKind(Standard::kPal, 314), SyncPulseKind::kVerticalSync);
...
TEST(SignalTimingModelTest, ClassifiesNtscSyncBlocksAndLineKinds) {
  ...
  EXPECT_EQ(GetSyncPulseKind(Standard::kNtsc, 267), SyncPulseKind::kVerticalSync);
  ...
  EXPECT_EQ(GetLineContentKind(Standard::kNtsc, 263), LineContentKind::kVbiBlanking);
  EXPECT_EQ(GetLineContentKind(Standard::kNtsc, 283), LineContentKind::kVbiBlanking);
  EXPECT_EQ(GetLineContentKind(Standard::kNtsc, 284), LineContentKind::kActivePicture);
}
