...
std::string WriteTempYaml(const std::string& file_name,
...
TEST(YamlProjectParserTest, ParsesProgressiveSectionWithAllDuration) {
  const std::string path =
      WriteTempYaml("videosynth_parser_progressive_all.yaml",
                    "project:\n"
                    "  name: ProgressiveAll\n"
                    "  version: \"1.0\"\n"
                    "cvbs_presets:\n"
...
TEST(YamlProjectParserTest, ParsesProgressiveSectionWithIntegerDuration) {
  const std::string path =
      WriteTempYaml("videosynth_parser_progressive_int.yaml",
                    "project:\n"
...
TEST(YamlProjectParserTest, ParsesOptionalNtscBlackSetupIre) {
  const std::string path =
      WriteTempYaml("videosynth_parser_ntsc_black_setup.yaml",
                    "project:\n"
                    "  name: NtscZeroSetup\n"
                    "  version: \"1.0\"\n"
                    "cvbs_presets:\n"
...
TEST(YamlProjectParserTest, RejectsInvalidDurationFramesScalar) {
  const std::string path =
      WriteTempYaml("videosynth_parser_progressive_bad_duration.yaml",
                    "project:\n"
...
TEST(YamlProjectParserTest, ParsesLineInjectionsAndLaserdiscPresetFlags) {
  const std::string path =
      WriteTempYaml("videosynth_parser_line_injections.yaml",
                    "project:\n"
                    "  name: InjectionParse\n"
                    "  version: \"1.0\"\n"
                    "cvbs_presets:\n"
...
TEST(YamlProjectParserTest, RejectsUnsupportedLineInjectionField) {
  const std::string path =
      WriteTempYaml("videosynth_parser_line_injections_unsupported_field.yaml",
                    "project:\n"
...
TEST(YamlProjectParserTest, RejectsDeprecatedSourcePixelFormatField) {
  const std::string path =
      WriteTempYaml("videosynth_parser_rejects_source_pixel_format.yaml",
                    "project:\n"
