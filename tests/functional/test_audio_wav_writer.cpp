 ...
 * Purpose:     Validates the RIFF/WAVE stereo 24-bit PCM output AudioWavWriter
 *              produces. Path derivation is covered by the unit suite in
 *              tests/unit/test_audio_wav_writer_paths.cpp.
 *
